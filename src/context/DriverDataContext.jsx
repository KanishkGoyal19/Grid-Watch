    ...
    useEffect(() => {
        const fetchAll = async () => {
            try {
                ...
                // Custom image override for drivers
                merged.forEach(driver => {
                    if (driver.full_name === 'Franco COLAPINTO') {
                        driver.imageSlug = 'https://media.formula1.com/d_driver_fallback_image.png/content/dam/fom-website/drivers/F/FRACOL01_Franco_Colapinto/fracol01.png';
                    }
                });
